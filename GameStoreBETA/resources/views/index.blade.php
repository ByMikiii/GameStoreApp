...
<a href="/game/{{$newgame->slug}}" class="w-80 h-48 bg-scnd-color rounded-md hover:text-tx-color hover:brightness-110 hover:scale-110 text-tx-color mb-14 mx-auto">
...
<a href="/game/{{$saleGame->slug}}" class="w-80 h-48 bg-scnd-color rounded-md hover:brightness-110 hover:scale-110 text-tx-color hover:text-tx-color mb-14 mx-auto">
...
<a href="/game/{{$game->slug}}" class="w-80 h-48 bg-scnd-color rounded-md hover:text-tx-color hover:brightness-110 hover:scale-110 text-tx-color mb-14 mx-auto">

    <img class="object-cover rounded-t-md w-full h-2/3" src="{{ asset('/images/games/'.$game->slug.'/banner-1.jpg') }}" alt="Image of {{$game->name}}"> 

<div class="flex text-left h-1/3 p-3 relative">
    <div class="w-56 truncate">
